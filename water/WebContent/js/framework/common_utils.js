...
var main_page_processing_tips='<img style="width: 20px;height: 20px;" src="imgs/processing.gif"></img><span >加载中..</span>';
var main_page_success_tips='<img style="width: 16px;height: 16px;" src="imgs/check.gif"></img><span >&nbsp;&nbsp;处理成功</span>';
var main_page_error_tips='<img style="width: 14px;height: 14px;" src="imgs/cross.png"></img><span >&nbsp;&nbsp;处理失败,请重试</span>';
...
function show_user_msg(msg)
{
	...
	{
		var main_page_user_msg_tips='<img style="width: 16px;height: 16px;" src="/water/image/exclamation.png"></img>&nbsp;&nbsp;<span id="main_page_msg_tips_span_id">信息提示</span>';
...
function open_delete_confirm_dialog(callback,entityid,message)//message is OPTIONAL, entityid could be an array
{
