...
function ajax_upload_js_open_upload_dialog(args_array)
{
	...
	load_js_then_exec_func_util('js/upload/swf/js/swfupload/swfupload_merge_two.js','ajax_upload_js_initial_upload',args_array);
...
function ajax_upload_js_initial_upload(args_array)
{
	...
	$('#t_course_dev_testpaper_js_swfupload-control').swfupload({
		...
		flash_url : "js/upload/swf/js/swfupload/swfupload.swf",
		button_image_url : 'js/upload/swf/js/swfupload/wdp_buttons_upload_114x29.png',
		button_width : 70,
		button_height : 25,
